...
- This is not a true absolute 2D map.
- There is no GPS location.
- Fixed anchors are not used, so the map is only relative inside the team.
- UWB antenna orientation, human body obstruction, trees, walls, and metal can affect accuracy.
