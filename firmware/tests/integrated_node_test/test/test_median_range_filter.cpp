...
int main() {
  ...
  RUN_TEST(testRadarBpmLostAlertWaitsFiveMinutesForNoFinger);
  RUN_TEST(testRadarBpmLostAlertResetsWhenBpmReturns);
  ...
  RUN_TEST(test_bpm_lost_telemetry_waits_for_alert_flag);
  ...
  RUN_TEST(testMax30102DiagnosticsReportsNoFingerBeforeStaleBpm);
  RUN_TEST(testMax30102DiagnosticsRequiresBpmValidForOk);
  ...
  RUN_TEST(testMax30102DiagnosticsAllowsWristLowIrAcWhenSignalUsable);
  RUN_TEST(testMax30102SignalReasonLabelsExposeWristHysteresis);
  RUN_TEST(testMax30102DiagnosticsReportsLowIrAcRatioAfterIrAcPasses);
  RUN_TEST(testMax30102DiagnosticsReportsLowSignalWhenWindowNotReady);
  RUN_TEST(testMax30102DiagnosticsReportsNoBeatWhenSignalLooksUsable);
  RUN_TEST(testMax30102DiagnosticsReportsUnstableBeatAfterRejectedInterval);
  RUN_TEST(testMax30102DiagnosticsReportsRefractoryReject);
  RUN_TEST(testMax30102DiagnosticsReportsIntervalReject);
  RUN_TEST(testMax30102DiagnosticsRejectsTableReflectionWithStaleAverage);
  RUN_TEST(testMax30102DiagnosticsReportsFingerSignalOk);
  RUN_TEST(testMax30102DiagnosticsReportsFingerWaitingStable);
  RUN_TEST(testMax30102DiagnosticsDoesNotReportOkWithoutBpmValid);
  RUN_TEST(testMax30102BeatDecisionSeedsFirstAcceptedBeat);
  RUN_TEST(testMax30102BeatDecisionReseedsStaleAcceptedClock);
  RUN_TEST(testMax30102BeatDecisionRejectsShortAndRefractoryIntervals);
  RUN_TEST(testMax30102BeatDecisionAcceptsPhysiologicInterval);
